                    ...
                    foreach (string sheet in sheetOrder)
                    {
                        ...
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    case "Depo":
                                        cmd.CommandText = "INSERT INTO depo (kod, depo) VALUES (@p1, @p2) ON CONFLICT DO NOTHING";
                                    ...
                                    case "Cari Kart":
                                        cmd.CommandText = "INSERT INTO cari_kart (cari_kodu, cari_adi, tip) VALUES (@p1, @p2, @p3) ON CONFLICT DO NOTHING";
                                    ...
                                    case "Arac Kartlari":
                                        cmd.CommandText = "INSERT INTO arac_kartlari (arac_kodu, plaka, marka_model, kasa_tipi, maks_agirlik_kg, maks_hacim_m3, km_maliyeti_tl) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7) ON CONFLICT DO NOTHING";
                                        cmd.Parameters.AddWithValue("p1", val(0));
                                        cmd.Parameters.AddWithValue("p2", val(1));
                                        cmd.Parameters.AddWithValue("p3", val(2));
                                        cmd.Parameters.AddWithValue("p4", val(3));
                                        cmd.Parameters.AddWithValue("p5", row[4] != DBNull.Value ? Convert.ToInt32(row[4]) : 0);
                                    ...
                                    case "İşyeri Stok":
                                        cmd.CommandText = "INSERT INTO isyeri_stok (depo, stok, miktar) VALUES (@p1, @p2, @p3) ON CONFLICT DO NOTHING";
                                        cmd.Parameters.AddWithValue("p1", val(0));
                                        cmd.Parameters.AddWithValue("p2", val(1));
                                    ...
                                    case "Satış Teklifi":
                                        cmd.CommandText = "INSERT INTO satis_teklifi (teklif_no, cari) VALUES (@p1, @p2) ON CONFLICT DO NOTHING";
                                        cmd.Parameters.AddWithValue("p1", val(0));
                                        cmd.Parameters.AddWithValue("p2", val(1));
                                        break;

                                    case "Satış Siparişi":
                                        cmd.CommandText = "INSERT INTO satis_siparisi (siparis_no, teklif, cari, arac_kodu, plaka, toplam_kg, toplam_hacim_m3, kapasite_durumu) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8) ON CONFLICT DO NOTHING";
                                        cmd.Parameters.AddWithValue("p1", val(0));
                                        cmd.Parameters.AddWithValue("p2", val(1));
                                        cmd.Parameters.AddWithValue("p3", val(2));
                                        cmd.Parameters.AddWithValue("p4", val(3));
                                        cmd.Parameters.AddWithValue("p5", val(4));
                                        cmd.Parameters.AddWithValue("p6", row[5] != DBNull.Value ? Convert.ToInt32(row[5]) : 0);
                                        cmd.Parameters.AddWithValue("p7", row[6] != DBNull.Value ? Convert.ToDecimal(row[6]) : 0m);
                                        cmd.Parameters.AddWithValue("p8", val(7));
                                        break;
                                    ...
                                    case "İrsaliye":
                                        cmd.CommandText = "INSERT INTO irsaliye (irsaliye_no, siparis, depo, arac_kodu, plaka, toplam_kg, toplam_hacim_m3, kapasite_durumu) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8) ON CONFLICT DO NOTHING";
                                        cmd.Parameters.AddWithValue("p1", val(0));
                                        cmd.Parameters.AddWithValue("p2", val(1));
                                        cmd.Parameters.AddWithValue("p3", val(2));
                                        cmd.Parameters.AddWithValue("p4", val(4));
                                        cmd.Parameters.AddWithValue("p5", val(5));
                                        cmd.Parameters.AddWithValue("p6", row[6] != DBNull.Value ? Convert.ToInt32(row[6]) : 0);
                                        cmd.Parameters.AddWithValue("p7", row[7] != DBNull.Value ? Convert.ToDecimal(row[7]) : 0m);
                                        cmd.Parameters.AddWithValue("p8", val(8));
                                        break;

                                    case "Fatura":
                                        cmd.CommandText = "INSERT INTO fatura (fatura_no, irsaliye_no, cari, tutar, odeme) VALUES (@p1, @p2, @p3, @p4, @p5) ON CONFLICT DO NOTHING";
                                        cmd.Parameters.AddWithValue("p1", val(0));
                                        cmd.Parameters.AddWithValue("p2", val(1));
                                        cmd.Parameters.AddWithValue("p3", val(2));
                                    ...
                                    case "Sevkiyat_Plani":
                                        cmd.CommandText = "INSERT INTO sevkiyat_plani (sevkiyat_no, arac_kodu, plaka, toplam_kg, toplam_hacim_m3) VALUES (@p1, @p2, @p3, @p4, @p5) ON CONFLICT DO NOTHING";
                                        cmd.Parameters.AddWithValue("p1", val(0));
                                        cmd.Parameters.AddWithValue("p2", val(1));
                                        cmd.Parameters.AddWithValue("p3", val(2));
                                        cmd.Parameters.AddWithValue("p4", row[3] != DBNull.Value ? Convert.ToDecimal(row[3]) : 0m);
